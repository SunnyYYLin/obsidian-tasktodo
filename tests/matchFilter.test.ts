...
describe("matchFilter", () => {
	test("completed status filtering", () => {
		const todoItem = makeTestItem({ task: { status: { symbol: " ", type: "TODO" }, metadata: { description: "t", dates: {} } } });
		const doneItem = makeTestItem({ task: { status: { symbol: "x", type: "DONE" }, metadata: { description: "t", dates: {} } } });
	...
	test("cancelled status filtering", () => {
		const todoItem = makeTestItem({ task: { status: { symbol: " ", type: "TODO" }, metadata: { description: "t", dates: {} } } });
		const cancelledItem = makeTestItem({ task: { status: { symbol: "-", type: "CANCELLED" }, metadata: { description: "t", dates: {} } } });
	...
	test("priority filtering", () => {
		const highItem = makeTestItem({ task: { status: { symbol: " ", type: "TODO" }, metadata: { description: "t", priority: "⏫", dates: {} } } });
		const noneItem = makeTestItem({ task: { status: { symbol: " ", type: "TODO" }, metadata: { description: "t", priority: null, dates: {} } } });
